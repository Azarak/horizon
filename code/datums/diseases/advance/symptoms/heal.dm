...
/datum/symptom/heal/starlight/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	var/list/parts = M.get_damaged_bodyparts(TRUE, TRUE, BODYPART_ORGANIC)

	if(!parts.len)
		return

	for(var/obj/item/bodypart/L in parts)
		if(L.heal_damage(heal_amt/parts.len, heal_amt/parts.len, BODYPART_ORGANIC))
...
/datum/symptom/heal/darkness/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	for(var/obj/item/bodypart/L in parts)
		if(L.heal_damage(heal_amt/parts.len, heal_amt/parts.len * 0.5, BODYPART_ORGANIC)) //more effective on brute
			M.update_damage_overlays()
	return 1
...
/datum/symptom/heal/water/Heal(mob/living/carbon/M, datum/disease/advance/A, actual_power)
	...
	var/list/parts = M.get_damaged_bodyparts(TRUE, TRUE, BODYPART_ORGANIC) //more effective on burns
	...
	for(var/obj/item/bodypart/L in parts)
		if(L.heal_damage(heal_amt/parts.len * 0.5, heal_amt/parts.len, BODYPART_ORGANIC))
			M.update_damage_overlays()
