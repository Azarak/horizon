...
Sound names must be in the format of [song name]+[length in deciseconds]+[beat in deciseconds]+[volume].ogg

A three minute song title "SS13" that lasted 3 minutes would have a file name SS13+1800+5+100.ogg