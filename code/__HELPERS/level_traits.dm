...
#define is_station_level(atom) SSmapping.virtual_level_trait(atom, ZTRAIT_STATION)

#define is_mining_level(atom) SSmapping.virtual_level_trait(atom, ZTRAIT_MINING)
